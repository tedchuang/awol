...
class _ReportPageState extends State<ReportPage> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    widget.model.calendar(
      daUser: widget.model.user.userId,
      daWhse: widget.model.user.userWhse,
    );
