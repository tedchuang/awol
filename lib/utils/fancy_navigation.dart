...
import './fancy_clipper.dart';
import './fancy_painter.dart';
import './fancy_tabs.dart';

const double CIRCLE_SIZE = 60; // 60
const double ARC_HEIGHT = 70; // 70
const double ARC_WIDTH = 90; // 90
const double CIRCLE_OUTLINE = 10; // 10
const double SHADOW_ALLOWANCE = 20; // 20
const double BAR_HEIGHT = 60; // 60
...
class FancyBottomNavigationState extends State<FancyBottomNavigation>
  ...
  Widget build(BuildContext context) {
    double _bumper = widget.chinBump ? 20 : 0;
    double _padder = widget.chinBump ? 34 : 14; // was 35 : 15
    ...
    return Stack(
      ...
      children: <Widget>[
        Container(
          padding: EdgeInsets.only(bottom: _bumper), // new line!!
          height: widget.chinBump ? BAR_HEIGHT + _bumper : BAR_HEIGHT,
          ...
          child: Row(
            ...
            children: widget.tabs
                .map((t) => TabItem(
                    ...
                    iconData: t.iconData,
                    title: t.key == widget.tabs[currentSelected].key
                        ? t.title
                        : '',
        ...
        Positioned.fill(
          ...
          child: Container(
            child: AnimatedAlign(
              ...
              child: Padding(
                padding: EdgeInsets.only(bottom: _padder), // 15
